...
class ClockViewState extends ConsumerState<ClockView> {
  @override
  void initState() {
...
class ClockPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    var hourHandX = centerX + 40 * cos((dateTime.hour * 30 + dateTime.minute * 0.5) * pi / 180);
    var hourHandY = centerX + 40 * sin((dateTime.hour * 30 + dateTime.minute * 0.5) * pi / 180);
